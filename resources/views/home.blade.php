...
// server script.
                ...
                $('#loadimage').hide();//image may not be visible at all as there are not many records in DB
            }
    //-->
</script>
<form name='myForm'>
    ...
    <input type='button' onclick='ajaxFunction()' value='Search' class="btn btn-default btn-primary btn-block"/>

</form>
<div id = 'loadimage' style= 'display:none;'><img src= 'ajax-loader.gif'/></div>
<div class="col-sm-12 text-center" id='ajaxDiv'>Your search results will display here...</div>
</div>
</body>
</html>
